...
**Source Language:** Vietnamese (`ARCHITECTURE.vi.md`) | **English Translation:** `ARCHITECTURE.en.md`

---

## Donation — Xác Thực Địa Chỉ Chính Thức / Official Address Verification
